...
window.I18N = (function () {
  ...
  var EN = {
    ...
    /* отчёт «до и после» */
    'Отчёт «до и после»': 'Before-and-after report',
    'Не удалось загрузить формы замера.': 'Could not load the assessment forms.',
    'Замера ещё не было': 'No assessment yet',
    'Отчёт сравнивает входной и итоговый тесты. Начните с входного: 20 задач, 40 минут.':
      'The report compares the starting and final tests. Begin with the starting test: 20 problems, 40 minutes.',
    '▶ Входной тест': '▶ Starting test',
    'Показать пример отчёта': 'Show a sample report',
    'Итог': 'Summary',
    'не пройден': 'not taken',
    'ещё впереди': 'still ahead',
    'Прирост': 'Growth',
    '{a}% → {b}% верных': '{a}% → {b}% correct',
    'Время на задачу': 'Time per problem',
    'с': 's',
    'в среднем на задачу с ответом': 'average per answered problem',
    'Итоговый тест решают в конце программы (день 27–28). Ему достанется другая форма той же сложности.':
      'The final test is taken at the end of the programme (day 27–28). It uses the other form, of the same difficulty.',
    'Перейти к итоговому': 'Go to the final test',
    'По разделам: доля верных ответов': 'By area: share of correct answers',
    'до': 'before',
    'после': 'after',
    'Раздел': 'Area',
    'задач': 'problems',
    'Числа и действия': 'Numbers and operations',
    'Текстовые задачи': 'Word problems',
    'Закономерности и логика': 'Patterns and logic',
    'Геометрия и измерения': 'Geometry and measurement',
    'пусто': 'blank',
    'научился': 'learned',
    'умел и умеет': 'still solid',
    'просело': 'slipped',
    'пока не выходит': 'not yet',
    'По темам': 'By topic',
    'Задача №k во входном и итоговом тесте — одна тема и одна сложность, числа разные.':
      'Problem k in the starting and final tests has the same topic and difficulty, with different numbers.',
    'Тема': 'Topic',
    'Над чем работать дальше:': 'What to work on next:',
    'Программа': 'Programme',
    'точность на занятиях': 'accuracy in lessons',
    '{a} из {n} задач': '{a} of {n} problems',
    'пробные экзамены': 'mock exams',
    'из 85 баллов': 'out of 85 points',
    'ещё не было': 'none yet',
    'в журнале ошибок': 'in the error journal',
    'задач ждут повторения': 'problems waiting for review',
    'Как читать этот отчёт': 'How to read this report',
    'Формы A и B составлены парами одинаковой сложности, но на большой выборке не выверены: разница в 1–2 балла может быть случайной.':
      'Forms A and B are built as pairs of equal difficulty but have not been calibrated on a large sample: a difference of 1–2 points may be chance.',
    'Прирост за месяц складывается из программы, школы и взросления. Отделить их помогает контрольная группа, которая пишет те же тесты без программы.':
      'A month of growth comes from the programme, from school and from growing up. A control group taking the same tests without the programme separates them.',
    '«Пусто» — задача без ответа. За ошибку здесь не снимают, поэтому пустые ответы — сами по себе повод поговорить о тактике.':
      '“Blank” means no answer was given. Wrong answers lose nothing here, so blanks are themselves worth a conversation about tactics.',
    '🖨 Печать или PDF': '🖨 Print or PDF',

    /* облако: аккаунт, ученики, панель учителя */
    'Войти, чтобы прогресс сохранялся в облаке': 'Sign in to keep progress in the cloud',
    'Выбери, кто решает': 'Choose who is solving',
    'сохраняем…': 'saving…',
    'сохранено': 'saved',
    'нет связи — сохраним позже': 'offline — will save later',
    'для взрослых': 'for adults',
    'Аккаунт и ученики': 'Account and pupils',
    'Что-то пошло не так.': 'Something went wrong.',
    'Нет связи с сервером. Проверь интернет.': 'No connection to the server. Check the internet.',
    'Код не подошёл или устарел. Запроси новый.': 'The code did not match or has expired. Request a new one.',
    'Класса с таким кодом нет. Проверь код у учителя.': 'There is no class with that code. Check it with the teacher.',
    'Что хранится и кто это видит': 'What is stored and who sees it',
    'О взрослом: адрес почты (для входа), роль и, если хотите, имя.': 'About the adult: an email address (to sign in), a role and, optionally, a name.',
    'О ребёнке: только псевдоним, класс и ответы в тренажёре — какие задачи решены, за сколько секунд, какие ошибки. Ни имени, ни фамилии, ни даты рождения, ни почты ребёнка.':
      'About the child: only a nickname, a grade and their answers: which problems were solved, in how many seconds, which mistakes. No name, surname, date of birth or email of the child.',
    'Видите вы. Учитель видит прогресс ребёнка, только если вы сами записали его в класс по коду.':
      'You see it. A teacher sees the child’s progress only if you add the child to their class with a code.',
    'Данные ребёнка можно скачать одним файлом и удалить целиком — кнопки рядом с профилем.':
      'A child’s data can be downloaded as one file and deleted completely: the buttons are next to the profile.',
    'Без входа тренажёр работает как раньше: всё хранится только в этом браузере.':
      'Without signing in everything works as before: all data stays in this browser only.',
    'Облако не настроено': 'The cloud is not set up',
    'Тренажёр работает без аккаунтов: прогресс хранится в этом браузере. Чтобы включить вход и синхронизацию, администратор сайта заполняет assets/cloud-config.js (см. supabase/README.md).':
      'The programme works without accounts: progress is kept in this browser. To enable sign-in and sync, the site administrator fills in assets/cloud-config.js (see supabase/README.md).',
    'Вход для взрослых': 'Sign-in for adults',
    'Пароль не нужен: на почту придёт шестизначный код. Аккаунт создаётся при первом входе.':
      'No password needed: a six-digit code arrives by email. The account is created on first sign-in.',
    'Почта': 'Email',
    'Получить код': 'Get a code',
    'Код из письма': 'Code from the email',
    'Войти': 'Sign in',
    'Проверь адрес почты.': 'Check the email address.',
    'Код отправлен на {e}. Письмо может идти пару минут; проверь и «Спам».':
      'The code was sent to {e}. It can take a couple of minutes; check the spam folder too.',
    'Код — это цифры из письма.': 'The code is the digits from the email.',
    'Один раз перед началом': 'Once, before you start',
    'Кто вы': 'Who you are',
    'Родитель или опекун': 'Parent or guardian',
    'Учитель или руководитель кружка': 'Teacher or club leader',
    'Как к вам обращаться (необязательно)': 'What to call you (optional)',
    'Я прочитал(а), что хранится о детях и кто это видит (ниже), и согласен(на) на такую обработку данных. Согласие можно отозвать, удалив профили и аккаунт.':
      'I have read what is stored about children and who sees it (below), and I agree to this processing of data. Consent can be withdrawn by deleting the profiles and the account.',
    'Продолжить': 'Continue',
    'Без согласия облако включить нельзя. Тренажёр при этом работает и без входа.':
      'The cloud cannot be enabled without consent. The programme still works without signing in.',
    'Вы вошли как <b>{e}</b> · {r}': 'Signed in as <b>{e}</b> · {r}',
    'учитель': 'teacher',
    'родитель': 'parent',
    'Выйти': 'Sign out',
    '🏫 Панель учителя': '🏫 Teacher dashboard',
    'Ученики': 'Pupils',
    'выберите, кто сейчас решает на этом устройстве': 'choose who is solving on this device',
    'Добавить ученика': 'Add a pupil',
    'Псевдоним': 'Nickname',
    'например, Сокол': 'for example, Falcon',
    'Не настоящее имя: псевдонима достаточно, чтобы отличать детей.': 'Not a real name: a nickname is enough to tell children apart.',
    'Класс': 'Grade',
    'Согласие родителей этого ученика собрано школой (письменно или в школьной системе).':
      'Parental consent for this pupil has been collected by the school (on paper or in the school system).',
    'Я родитель или опекун этого ребёнка и согласен(на) на хранение его прогресса.':
      'I am this child’s parent or guardian and I agree to their progress being stored.',
    'Добавить': 'Add',
    'Впиши псевдоним.': 'Enter a nickname.',
    'Отметь согласие — без него профиль не создаётся.': 'Tick the consent box: a profile cannot be created without it.',
    'Пока никого. Добавьте ученика ниже.': 'Nobody yet. Add a pupil below.',
    '{g} класс': 'grade {g}',
    'решает сейчас': 'solving now',
    'Решает сейчас': 'Solving now',
    'В класс по коду': 'Join a class',
    'Скачать данные': 'Download data',
    'Удалить навсегда?': 'Delete for good?',
    'Удалить': 'Delete',
    'класс: {c}': 'class: {c}',
    'Код класса от учителя (6 знаков):': 'Class code from the teacher (6 characters):',
    'Записан в класс «{c}».': 'Added to class “{c}”.',
    'Перенесено. Прогресс теперь в профиле «{n}».': 'Done. The progress now belongs to “{n}”.',
    'Переносить нечего: у профиля уже есть свой прогресс.': 'Nothing to move: this profile already has its own progress.',
    'В этом браузере есть прогресс, решённый до входа. Перенести его в профиль «{n}»?':
      'This browser has progress from before sign-in. Move it to “{n}”?',
    'Перенести': 'Move it',
    'для учителя': 'for teachers',
    'Панель учителя': 'Teacher dashboard',
    '← аккаунт': '← account',
    'Сначала войдите в аккаунт учителя.': 'Sign in to a teacher account first.',
    'Новый класс': 'New class',
    'Название': 'Name',
    'например, 3А, кружок по средам': 'for example, 3A, Wednesday club',
    'Создать': 'Create',
    'Впиши название класса.': 'Enter a class name.',
    'Классов пока нет. Создайте первый — появится код, который родители вводят в аккаунте.':
      'No classes yet. Create one to get a code that parents enter in their account.',
    'код для родителей:': 'code for parents:',
    'В классе пока никого. Дайте родителям код класса или добавьте ученика сами.':
      'Nobody in this class yet. Give parents the class code or add a pupil yourself.',
    'Ученик': 'Pupil',
    'дни': 'days',
    'точность': 'accuracy',
    'экзамены': 'exams',
    ...
    'убрать?': 'remove?',
    'убрать': 'remove',
    'Оба теста у {n} из {m}; средний прирост {g} балла из 20.': '{n} of {m} have both tests; average growth {g} points out of 20.',
    '⬇ CSV': '⬇ CSV',
    '+ ученик (согласие собрала школа)': '+ pupil (consent collected by the school)',
    'Псевдоним ученика (не настоящее имя):': 'Pupil nickname (not a real name):',
    'Подтвердите: согласие родителей этого ученика собрано школой.': 'Please confirm: parental consent for this pupil has been collected by the school.',
    '← к классу': '← to the class',
    'Не удалось получить данные ученика из облака.': 'Could not get the pupil’s data from the cloud.',
